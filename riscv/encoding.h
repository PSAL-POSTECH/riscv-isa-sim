...
#define MATCH_TORCHSIM_MVIN 0x400302B
#define MASK_TORCHSIM_MVIN 0xFE00707F
#define MATCH_TORCHSIM_MVIN2 0x200302B
#define MASK_TORCHSIM_MVIN2 0xFE00707F
#define MATCH_TORCHSIM_MVIN3 0x1C00302B
#define MASK_TORCHSIM_MVIN3 0xFE00707F
#define MATCH_TORCHSIM_MVOUT 0x600302B
#define MASK_TORCHSIM_MVOUT 0xFE00707F
#define MATCH_TORCHSIM_CONFIG 0x302B    // 0000000  00000  00000  011  00000  0101011
#define MASK_TORCHSIM_CONFIG 0xFE00707F // 1111111  00000  00000  111  00000  1111111
#define MATCH_TORCHSIM_CONFIG2 0x800302B   // 0000100  00000  00000  011  00000  0101011
#define MASK_TORCHSIM_CONFIG2 0xFE00707F
#define MATCH_TORCHSIM_CONFIG3 0xA00302B   // 0000101  00000  00000  011  00000  0101011
#define MASK_TORCHSIM_CONFIG3 0xFE00707F
#define MATCH_TORCHSIM_CONFIG4 0xC00302B   // 0000110  00000  00000  011  00000  0101011
#define MASK_TORCHSIM_CONFIG4 0xFE00707F
#define MATCH_TORCHSIM_I_VPUSH 0x2200305B
#define MASK_TORCHSIM_I_VPUSH 0xFE00707F
#define MATCH_TORCHSIM_W_VPUSH 0x2600305B
#define MASK_TORCHSIM_W_VPUSH 0xFE00707F
#define MATCH_TORCHSIM_VPOP 0x0800305B
#define MASK_TORCHSIM_VPOP 0xFE00707F
#define MATCH_TORCHSIM_COMPUTE 0x600305B
#define MASK_TORCHSIM_COMPUTE 0xFE00707F
#define MATCH_TORCHSIM_VEXP 0x2C00305B
#define MASK_TORCHSIM_VEXP 0xFE00707F
#define MATCH_TORCHSIM_VERF 0x2000305B
#define MASK_TORCHSIM_VERF 0xFE00707F
#define MATCH_TORCHSIM_VTANH 0x2400305B
#define MASK_TORCHSIM_VTANH 0xFE00707F
...
DECLARE_INSN(torchsim_mvin, MATCH_TORCHSIM_MVIN, MASK_TORCHSIM_MVIN)
DECLARE_INSN(torchsim_mvin2, MATCH_TORCHSIM_MVIN2, MASK_TORCHSIM_MVIN2)
DECLARE_INSN(torchsim_mvin3, MATCH_TORCHSIM_MVIN3, MASK_TORCHSIM_MVIN3)
DECLARE_INSN(torchsim_mvout, MATCH_TORCHSIM_MVOUT, MASK_TORCHSIM_MVOUT)
DECLARE_INSN(torchsim_config, MATCH_TORCHSIM_CONFIG, MASK_TORCHSIM_CONFIG)
DECLARE_INSN(torchsim_config2, MATCH_TORCHSIM_CONFIG2, MASK_TORCHSIM_CONFIG2)
DECLARE_INSN(torchsim_config3, MATCH_TORCHSIM_CONFIG3, MASK_TORCHSIM_CONFIG3)
DECLARE_INSN(torchsim_config4, MATCH_TORCHSIM_CONFIG4, MASK_TORCHSIM_CONFIG4)
DECLARE_INSN(torchsim_i_vpush, MATCH_TORCHSIM_I_VPUSH, MASK_TORCHSIM_I_VPUSH)
DECLARE_INSN(torchsim_w_vpush, MATCH_TORCHSIM_W_VPUSH, MASK_TORCHSIM_W_VPUSH)
DECLARE_INSN(torchsim_vpop, MATCH_TORCHSIM_VPOP, MASK_TORCHSIM_VPOP)
DECLARE_INSN(torchsim_compute, MATCH_TORCHSIM_COMPUTE, MASK_TORCHSIM_COMPUTE)
DECLARE_INSN(torchsim_vexp, MATCH_TORCHSIM_VEXP, MASK_TORCHSIM_VEXP)
DECLARE_INSN(torchsim_verf, MATCH_TORCHSIM_VERF, MASK_TORCHSIM_VERF)
DECLARE_INSN(torchsim_vtanh, MATCH_TORCHSIM_VTANH, MASK_TORCHSIM_VTANH)
